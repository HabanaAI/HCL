#include "platform/gaudi2/hls2pcie_runtime_connectivity.h"
...
HLS2PCIERuntimeConnectivity::HLS2PCIERuntimeConnectivity(const int                   moduleId,
...
uint32_t HLS2PCIERuntimeConnectivity::getBackpressureOffset(const uint16_t nic) const
{
