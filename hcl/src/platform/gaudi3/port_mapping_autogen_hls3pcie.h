...
extern const Gen2ArchNicsDeviceSingleConfig g_hls3pcie_card_location_3_mapping;
extern const Gen2ArchNicsDeviceSingleConfig g_hls3pcie_card_location_4_mapping;
