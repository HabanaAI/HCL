...
#include "platform/gaudi3/port_mapping_autogen.h"  // for extern

// clang-format off

// <remote card location, remote nic, sub nic index>
const Gen2ArchNicsDeviceSingleConfig g_gaudi3_card_location_0_mapping = {
...
// <remote card location, remote nic, sub nic index>
const Gen2ArchNicsDeviceSingleConfig g_gaudi3_card_location_1_mapping = {
...
// <remote card location, remote nic, sub nic index>
const Gen2ArchNicsDeviceSingleConfig g_gaudi3_card_location_2_mapping = {
...
// <remote card location, remote nic, sub nic index>
const Gen2ArchNicsDeviceSingleConfig g_gaudi3_card_location_3_mapping = {
...
// <remote card location, remote nic, sub nic index>
const Gen2ArchNicsDeviceSingleConfig g_gaudi3_card_location_4_mapping = {
    ...
    std::make_tuple(-1, 14, 0),	// NIC=14
    std::make_tuple(-1, 15, 1),	// NIC=15
...
// <remote card location, remote nic, sub nic index>
const Gen2ArchNicsDeviceSingleConfig g_gaudi3_card_location_5_mapping = {
...
// <remote card location, remote nic, sub nic index>
const Gen2ArchNicsDeviceSingleConfig g_gaudi3_card_location_6_mapping = {
...
// <remote card location, remote nic, sub nic index>
const Gen2ArchNicsDeviceSingleConfig g_gaudi3_card_location_7_mapping = {
