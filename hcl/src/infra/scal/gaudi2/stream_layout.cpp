...
Gaudi2StreamLayout::Gaudi2StreamLayout() : Gen2ArchStreamLayout()
{
    initLayout();
...
// clang-format off
void Gaudi2StreamLayout::initLayout()
{
    ...
    m_streamLayout[HclStreamIndex::GC]           = {scalNames.schedulersNames[schedIdx], "gc", schedIdx, /*streamIndex*/ 5, eInternal};
}